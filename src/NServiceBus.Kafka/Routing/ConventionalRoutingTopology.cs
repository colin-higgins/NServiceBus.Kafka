...
//    /// <summary>
//    /// Implements the Kafka routing topology as described at http://codebetter.com/drusellers/2011/05/08/brain-dump-conventional-routing-in-Kafka/
//    /// take 4:
//    /// <list type="bullet">
...
//    /// and then pushes the message into the most specific queue letting Kafka do the fanout for him. (One publish, multiple receivers!)</description></item>
//    /// <item><description>we generate an exchange for each queue so that we can do direct sends to the queue. it is bound as a fanout exchange</description></item>
//    /// </list>
//    /// </summary>
