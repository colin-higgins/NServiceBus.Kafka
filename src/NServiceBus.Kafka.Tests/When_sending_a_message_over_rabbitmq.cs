namespace NServiceBus.Transports.Kafka.Tests
{
    using System;
    using System.Text;
    using global::Kafka.Client;
    using global::Kafka.Client.Events;
    using NUnit.Framework;
    using Unicast;
    using Unicast.Queuing;

    [TestFixture]
    class When_sending_a_message_over_Kafka : KafkaContext
    {
        [Test]
        ...
        public void Should_not_populate_the_callback_header()
        {
            Verify(new TransportMessageBuilder(),
                (t, r) => Assert.IsFalse(t.Headers.ContainsKey(KafkaMessageSender.CallbackHeaderKey)));
