namespace NServiceBus.Kafka.AcceptanceTests
{
    using System;
    ...
    using NServiceBus.Transports.Kafka;
    ...
    public class When_using_a_custom_message_id_strategy
    {
        ...
        public void Should_be_able_to_receive_messages_with_no_id()
        {
            ...
            Scenario.Define(context)
                   .WithEndpoint<Receiver>(b => b.Given((bus, c) =>
                   {
                       ...
                       var connectionManager = unicastBus.Builder.Build<IManageKafkaConnections>();
        ...
        public class Receiver : EndpointConfigurationBuilder
        {
            public Receiver()
            {
                //EndpointSetup<DefaultServer>(c=> c.UseTransport<KafkaTransport>()
